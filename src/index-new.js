 ...
 */
 ...
 export default class TimedSlideshow extends Component {
     ...
     animation() {
         ...
         if(items[index].type === 'photo' || items[index].type === 'Photo') {
     ...
     renderProgressBar() {
         ...
         if(!showProgressBar || items[index].type === 'Video') 
         {  
             console.log("HAIIII THIS IS VIDEO ")
            return null;
         }
     ...
     renderContent() {
         ...
         if(!loaded) return (
             <View style={{ flex: 1, backgroundColor: '#0B1013', justifyContent: 'center', alignItems: 'center' }}>
                 {/* <ActivityIndicator size="large" animating color="#69E7BE" /> */}
             </View>
         );
